...
public interface leixingMapper extends BaseDao<leixing, String> {
	/*
    ...
    List<leixing> selectByExampleWithBLOBs(leixingExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") leixing record, @Param("example") leixingExample example);
