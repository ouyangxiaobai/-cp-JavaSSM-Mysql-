...
$(function(){
    ...
    getData();
   	...
   	$("#addbutton").on("click",function(){
   		...
   		window.location.href=getIP()+"media/meishileixing/meishileixingAdd.jsp";
   	})
    ...
    $("#delbutton").on("click",function(){
    	...
    	if(confirm("确定要删除吗？")){
        	...
        	del.ajax(getIP()+"meishileixing.action?delMore",function(data){
        		if(data.success){
    ...
    function getData(){  
	   	...
	   	getPageData(sel,getIP()+"meishileixing.action?list",function(data){
...
function update(id){
	 ...
	 window.location.href=getIP()+"media/meishileixing/meishileixingModify.jsp?eid="+id;
}
//修改
function jieshu(id){
