...
<title></title>
	<meta charset="utf-8" />
 <script type="text/javascript" src="<%=basePath%>media/meishileixing/js/jquery-1.10.2.min.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/meishileixing/js/getIp.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/meishileixing/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/meishileixing/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/meishileixing/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/meishileixing/js/commcom.js"></script>
 
<script type="text/javascript" src="<%=basePath%>media/meishileixing/js/meishileixingList.js"></script>
<link rel="stylesheet" href="<%=basePath%>media/meishileixing/css/bootstrap.min.css" type="text/css"></link>
