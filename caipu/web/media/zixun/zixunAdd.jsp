...
<script type="text/javascript" src="<%=basePath%>media/zixun/js/zixunAdd.js"></script>
...
<script type="text/javascript" src="<%=basePath%>media/My97DatePicker/WdatePicker.js"></script>
  ...
  <link rel="stylesheet" href="<%=basePath%>media/zixun/css/uploadify.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section" >&nbsp;&nbsp;&nbsp;<font style="font-weight:bold">资讯添加</font></h3>
	<div class="row-fluid">
		<div class="span12">
