...
<script type="text/javascript" src="<%=basePath%>media/zixun/js/shoucangList.js"></script>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >收藏管理</font></h3>
	<div class="row-fluid">
		<div class="span12">
		 	<div class="btn-group listsearch horizontal">
		 	
		 	收藏名：<input type="text"  id="a1"/>
