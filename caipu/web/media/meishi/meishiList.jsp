...
<title></title>
	<meta charset="utf-8" />
 <script type="text/javascript" src="<%=basePath%>media/meishi/js/jquery-1.10.2.min.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/meishi/js/getIp.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/meishi/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/meishi/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/meishi/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/meishi/js/commcom.js"></script>
 
<script type="text/javascript" src="<%=basePath%>media/meishi/js/meishiList.js"></script>
<link rel="stylesheet" href="<%=basePath%>media/meishi/css/bootstrap.min.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >美食管理</font></h3>
	<div class="row-fluid">
		<div class="span12">
		 	<div class="btn-group listsearch horizontal">
		 	
		 	美食名：<input type="text"  id="a1"/>
	           ...
	           <thead>
	               <tr>
	                   <th style="width:5%;"><input type="checkbox"  id="queryCheckbox"  name="queryCheckbox" value=""></th>
	                    <th style="width:10%;">美食名称</th>
	                    <th style="width:10%;">美食类型</th> 
