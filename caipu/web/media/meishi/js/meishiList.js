...
$(function(){
    ...
    getData();
   	...
   	$("#addbutton").on("click",function(){
   		...
   		window.location.href=getIP()+"media/meishi/meishiAdd.jsp";
   	})
    ...
    $("#delbutton").on("click",function(){
    	...
    	if(confirm("确定要删除吗？")){
        	...
        	del.ajax(getIP()+"meishi.action?delMore",function(data){
        		if(data.success){
    ...
    function getData(){  
	   	...
	   	getPageData(sel,getIP()+"vmeishi.action?list",function(data){
...
function update(id){
	 ...
	 window.location.href=getIP()+"media/meishi/meishiModify.jsp?eid="+id;
}
//修改
function jieshu(id){
