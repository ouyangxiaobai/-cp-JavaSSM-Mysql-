...
<html>
  <head>
    ...
    <title>My JSP 'lefta.jsp' starting page</title>
	...
	<meta http-equiv="description" content="This is my page">
	 	  ...
	 	  <script type="text/javascript" src="media/js/jquery1.8.3.min.js"></script>
	  <script type="text/javascript" src="media/js/left.js"></script>
  
 
 <link rel="stylesheet" type="text/css" href="media/css/font-awesome.min.css">
<link rel="stylesheet" href="media/css/leftnav.css" media="screen" type="text/css">
 

	<script type="text/javascript" src="media/js/jquery.min.js"></script>
	<script type="text/javascript" src='media/js/leftnav.js'></script>
...
<div class="account-l fl">
	<a class="list-title">健康菜谱管理网站</a>
	<ul id="accordion" class="accordion" style="height:100%;">
	<!-- 	<li>
