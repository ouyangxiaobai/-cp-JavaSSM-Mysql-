...
<title></title>
	<meta charset="utf-8" />
 <script type="text/javascript" src="<%=basePath%>media/xingchengleixing/js/jquery-1.10.2.min.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/xingchengleixing/js/getIp.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/xingchengleixing/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/xingchengleixing/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/xingchengleixing/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/xingchengleixing/js/commcom.js"></script>
 
<script type="text/javascript" src="<%=basePath%>media/xingchengleixing/js/xingchengleixingList.js"></script>
<link rel="stylesheet" href="<%=basePath%>media/xingchengleixing/css/bootstrap.min.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >菜品类型管理</font></h3>
	<div class="row-fluid">
		<div class="span12">
		 	<div class="btn-group listsearch horizontal">
		 	
		 	菜品类型名：<input type="text"  id="a1"/>
