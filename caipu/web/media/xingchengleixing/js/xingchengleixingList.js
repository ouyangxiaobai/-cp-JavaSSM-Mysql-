...
$(function(){
    ...
    getData();
   	...
   	$("#addbutton").on("click",function(){
   		...
   		window.location.href=getIP()+"media/xingchengleixing/xingchengleixingAdd.jsp";
   	})
    ...
    $("#delbutton").on("click",function(){
    	...
    	if(confirm("确定要删除吗？")){
        	...
        	del.ajax(getIP()+"xingchengleixing.action?delMore",function(data){
        		if(data.success){
    ...
    function getData(){  
	   	...
	   	getPageData(sel,getIP()+"xingchengleixing.action?list",function(data){
...
function update(id){
	 ...
	 window.location.href=getIP()+"media/xingchengleixing/xingchengleixingModify.jsp?eid="+id;
}
//修改
function jieshu(id){
