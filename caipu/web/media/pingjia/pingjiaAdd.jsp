...
<script type="text/javascript" src="<%=basePath%>media/pingjia/js/pingjiaAdd.js"></script>
  
  <link rel="stylesheet" href="<%=basePath%>media/pingjia/css/bootstrap.min.css" type="text/css"></link>
  	<link rel="stylesheet" href="<%=basePath%>media/pingjia/css/uploadify.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section" >&nbsp;&nbsp;&nbsp;<font style="font-weight:bold">留言添加</font></h3>
	<div class="row-fluid">
		<div class="span12">
		...
		<div class="form-horizontal m-t">
            <div class="control-group">
             ...
             <div class="control-group">
                ...
                <textarea rows="6" cols="40" id="a2" name="a3">
            ...
            <div class="form-actions">
				<button id="add" onclick="pingjiaadd()" type="button" class="btn blue">保存</button>
