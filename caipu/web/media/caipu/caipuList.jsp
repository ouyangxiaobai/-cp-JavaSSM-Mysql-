...
<title></title>
	<meta charset="utf-8" />
 <script type="text/javascript" src="<%=basePath%>media/caipu/js/jquery-1.10.2.min.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/caipu/js/getIp.js"></script>
 <script type="text/javascript" src="<%=basePath%>media/caipu/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/caipu/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/caipu/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/caipu/js/commcom.js"></script>
 
<script type="text/javascript" src="<%=basePath%>media/caipu/js/caipuList.js"></script>
<link rel="stylesheet" href="<%=basePath%>media/caipu/css/bootstrap.min.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >菜谱管理</font></h3>
	<div class="row-fluid">
		<div class="span12">
		 	<div class="btn-group listsearch horizontal">
		 	
		 	菜谱名：<input type="text"  id="a1"/>
