...
<script type="text/javascript" src="<%=basePath%>media/caipu/js/caipuAdd.js"></script>

<script type="text/javascript" src="<%=basePath%>media/My97DatePicker/WdatePicker.js"></script>

  <jsp:include page="../media.jsp"></jsp:include>
  
  <link rel="stylesheet" href="<%=basePath%>media/caipu/css/bootstrap.min.css" type="text/css"></link>
  <link rel="stylesheet" href="<%=basePath%>media/caipu/css/uploadify.css" type="text/css"></link>
...
<div class="tab-content contents"> 
	<h3 class="form-section" >&nbsp;&nbsp;&nbsp;<font style="font-weight:bold">菜谱添加</font></h3>
	<div class="row-fluid">
		<div class="span12">
	 <div class="portlet-body list mbModify">
		<div class="form-horizontal m-t">
            <div class="control-group">
             ...
             <div class="control-group">
                        <label class="control-label">菜谱内容：</label>
                        <div class="controls">
